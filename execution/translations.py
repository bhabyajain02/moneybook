...
_T = {
    ...
    # ── Photo processing ────────────────────────────────────────
    'photo_processing': {
        'english':  "📷 Photo received! You will be notified when your entries are ready.",
        'hindi':    "📷 फोटो मिल गई! जब एंट्री तैयार होंगी तो आपको सूचित किया जाएगा।",
        'hinglish': "📷 Photo mil gayi! Jab entries ready hongi toh aapko bata denge.",
        'gujarati': "📷 ફોટો મળ્યો! એન્ટ્રી તૈયાર થશે ત્યારે તમને જાણ કરાશે.",
        'marathi':  "📷 फोटो मिळाला! एंट्री तयार झाल्यावर तुम्हाला कळवले जाईल.",
        'bengali':  "📷 ছবি পেয়েছি! এন্ট্রি তৈরি হলে আপনাকে জানানো হবে।",
        'tamil':    "📷 புகைப்படம் கிடைத்தது! பதிவுகள் தயாரானதும் உங்களுக்கு தெரிவிக்கப்படும்.",
        'telugu':   "📷 ఫోటో వచ్చింది! ఎంట్రీలు సిద్ధమైనప్పుడు మీకు తెలియజేయబడుతుంది.",
        'kannada':  "📷 ಫೋಟೋ ಸಿಕ್ಕಿತು! ಎಂಟ್ರಿಗಳು ಸಿದ್ಧವಾದಾಗ ನಿಮಗೆ ತಿಳಿಸಲಾಗುವುದು.",
        'punjabi':  "📷 ਫੋਟੋ ਮਿਲ ਗਈ! ਐਂਟਰੀਆਂ ਤਿਆਰ ਹੋਣ 'ਤੇ ਤੁਹਾਨੂੰ ਦੱਸਿਆ ਜਾਵੇਗਾ।",
    },
    'photo_empty': {
